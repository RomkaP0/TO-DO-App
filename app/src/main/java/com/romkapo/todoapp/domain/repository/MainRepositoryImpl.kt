...
import com.romkapo.todoapp.data.local.BadRequestException
import com.romkapo.todoapp.data.local.ClientSideException
import com.romkapo.todoapp.data.local.ItemNotFoundException
import com.romkapo.todoapp.data.local.NetworkException
import com.romkapo.todoapp.data.local.Resource
import com.romkapo.todoapp.data.local.SyncFailedException
import com.romkapo.todoapp.data.local.TodoItem
import com.romkapo.todoapp.data.local.UnSyncAction
import com.romkapo.todoapp.data.local.UpdateFailedException
...
import com.romkapo.todoapp.data.network.toNetworkItem
import com.romkapo.todoapp.data.network.toOperationItem
import com.romkapo.todoapp.data.network.toTodoItem
